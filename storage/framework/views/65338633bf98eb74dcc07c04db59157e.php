...
<body>
    ...
    <form action="<?php echo e(route('catalogs.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\laravel\sistema_final_poo_lirios\resources\views/catalogs/create.blade.php ENDPATH**/ ?>