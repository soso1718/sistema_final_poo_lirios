<x-app-layout>
    <div class="min-h-screen bg-gray-100 pb-10">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
            ...
            <form action="{{route('professionals.update', $professional->id)}}" method="POST" id="professional-edit-form">
                @method('PUT')
                @csrf
                
                <div class="flex items-center justify-between mb-6">
                    <h1 class="text-5xl font-serif" style="color: #4CAF50;">
                        Editar profissional: {{ $professional->name }}
                    </h1>
                    <button type="submit" 
                ...
                @if ($errors->any())
                    <div class="p-4 mb-4 rounded-lg bg-red-100 text-red-700 font-medium">
                        <p>Houve um erro ao tentar editar o profissional:</p>
                ...
                <div class="p-10 rounded-2xl shadow-lg" style="border: 2px solid #58A663; background-color: #FFECEF;">
                    ...
                    <div class="grid grid-cols-2 gap-x-12 gap-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="specialty" required value="{{ old('specialty', $professional->specialty) }}"
                                class="w-full py-3 px-4 rounded-xl border-none shadow-inner text-lg transition duration-150"
                                style="background-color: #FDE7EE; color: #333333;">
                        </div>
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="text" name="available_times" id="available_times" required value="{{ old('available_times', $professional->available_times) }}"
                                class="w-full py-3 px-4 rounded-xl border-none shadow-inner text-lg transition duration-150"
                                style="background-color: #FDE7EE; color: #333333;">
                        </div>
