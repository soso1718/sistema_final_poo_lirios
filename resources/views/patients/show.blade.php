                ...
                <div class="flex space-x-4">
                    ...
                    <a href="{{ route('patients.index') }}">
                        <button class="py-2 px-6 rounded-lg text-white text-lg font-semibold transition duration-300 ease-in-out hover:opacity-90"
                                style="background-color: #F0A5B7;"> Voltar
                        </button>
                    </a>
                    
                    <a href="{{ route('patients.edit', $patient->id) }}">
                        <button class="py-2 px-6 rounded-lg text-white text-lg font-semibold transition duration-300 ease-in-out hover:opacity-90"
                                style="background-color: #4d8b55ff;">
                            Editar
                        </button>
                    </a>
            ...
            <div class="p-10 rounded-2xl shadow-lg" style="border: 2px solid #58A663; background-color: #FFECEF;">
                ...
                <div class="grid grid-cols-2 gap-x-12 gap-y-6">
                    ...
                    <div class="bg-white p-4 rounded-xl shadow-md" style="background-color: #FAFAFA;">
                        ...
                        <p class="text-xl font-medium text-gray-800">{{$patient->name}}</p>
                    </div>
                    ...
                    <div class="bg-white p-4 rounded-xl shadow-md" style="background-color: #FAFAFA;">
                        ...
                        <p class="text-xl font-medium text-gray-800">{{$patient->cpf}}</p>
                    </div>
                    
                    <div class="bg-white p-4 rounded-xl shadow-md" style="background-color: #FAFAFA;">
                        <span class="block text-lg font-serif mb-1" style="color: #F0A5B7;">E-mail:</span>
                        <p class="text-xl font-medium text-gray-800">{{$patient->email}}</p>
                    </div>
