        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
            ...
            <div class="flex items-center justify-between mb-6">
                <h1 class="text-5xl font-serif" style="color: #4CAF50;">
                    Detalhes do Fornecedor: {{ $supplier->name }}
                </h1>
            ...
            <div class="p-10 rounded-2xl shadow-lg" style="border: 2px solid #58A663; background-color: #FFECEF;">
                ...
                <div class="grid grid-cols-2 gap-x-12 gap-y-6">
                    ...
                    <div class="bg-white p-4 rounded-xl shadow-md" style="background-color: #FAFAFA;">
                        <span class="block text-lg font-serif mb-1" style="color: #F0A5B7;">Nome/Razão Social:</span>
                        <p class="text-xl font-medium text-gray-800">{{$supplier->name}}</p>
                    </div>

                    <div class="bg-white p-4 rounded-xl shadow-md" style="background-color: #FAFAFA;">
                        <span class="block text-lg font-serif mb-1" style="color: #F0A5B7;">CNPJ:</span>
                        <p class="text-xl font-medium text-gray-800">{{$supplier->cnpj}}</p>
                    </div>
                    
                    <div class="bg-white p-4 rounded-xl shadow-md" style="background-color: #FAFAFA;">
                        <span class="block text-lg font-serif mb-1" style="color: #F0A5B7;">Contato (E-mail):</span>
                        <p class="text-xl font-medium text-gray-800">{{$supplier->contact}}</p>
                    </div>

                    <div class="bg-white p-4 rounded-xl shadow-md" style="background-color: #FAFAFA;">
                        <span class="block text-lg font-serif mb-1" style="color: #F0A5B7;">Produtos fornecidos:</span>
                        <p class="text-xl font-medium text-gray-800">{{$supplier->products_supplied}}</p>
                    </div>
