<x-app-layout>
    <div class="min-h-screen bg-gray-100 pb-10">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
            ...
            <form action="{{route('suppliers.update', $supplier->id)}}" method="POST" id="supplier-edit-form">
                @method('PUT')
                @csrf
                ...
                @if ($errors->any())
                    <div class="p-4 mb-4 rounded-lg bg-red-100 text-red-700 font-medium">
                        <p>Houve um erro ao tentar editar o fornecedor:</p>
                ...
                <div class="p-10 rounded-2xl shadow-lg" style="border: 2px solid #58A663; background-color: #FFECEF;">
                    ...
                    <div class="grid grid-cols-2 gap-x-12 gap-y-6">
                        ...
                        <div>
                            <label class="block text-xl font-serif mb-1" style="color: #F0A5B7;">Nome/Razão Social:</label>
                        ...
                        <div>
                            ...
                            <input type="text" name="cnpj" required value="{{ old('cnpj', $supplier->cnpj) }}"
                                class="w-full py-3 px-4 rounded-xl border-none shadow-inner text-lg transition duration-150"
                        ...
                        <div>
                            ...
                            <input type="email" name="contact" required value="{{ old('contact', $supplier->contact) }}"
                                class="w-full py-3 px-4 rounded-xl border-none shadow-inner text-lg transition duration-150"
                                style="background-color: #FDE7EE; color: #333333;">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="products_supplied" required value="{{ old('products_supplied', $supplier->products_supplied) }}"
                                class="w-full py-3 px-4 rounded-xl border-none shadow-inner text-lg transition duration-150"
                                style="background-color: #FDE7EE; color: #333333;">
                        </div>
